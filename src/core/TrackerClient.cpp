...
TrackerClient::TrackerClient(QObject *parent)
    ...
    , m_isActive(false)
{
    connect(m_udpSocket, &QUdpSocket::readyRead, this, &TrackerClient::onUdpReadyRead);
    connect(m_udpSocket, &QUdpSocket::errorOccurred, this, &TrackerClient::onUdpError);
    connect(m_nam, &QNetworkAccessManager::finished, this, &TrackerClient::onHttpFinished);
