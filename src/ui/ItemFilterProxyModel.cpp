...
bool ItemFilterProxyModel::filterAcceptsRow(int source_row, const QModelIndex &source_parent) const
{
    ...
    if (item.id.toLower().contains(textLower) || item.sourcePath.toLower().contains(textLower)) {
        return true;
    }
