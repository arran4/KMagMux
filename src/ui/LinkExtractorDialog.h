...
class LinkExtractorDialog : public QDialog
{
    Q_OBJECT
public:
    explicit LinkExtractorDialog(const QStringList &lines, bool extractMagnets, bool extractTorrents, QWidget *parent = nullptr);
    QStringList getExpandedLines() const
    {
        return m_expandedLines;
    }
