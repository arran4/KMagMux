...
AddItemDialog::AddItemDialog(Item &item, QWidget *parent)
    ...
    if (!m_item.connectorId.isEmpty()) {
        ...
        if (index >= 0) m_connectorCombo->setCurrentIndex(index);
    }
...
void AddItemDialog::setupUi() {
    ...
    m_deleteOriginalCheck = new QCheckBox("Delete original file after action", this);
    ...
    connect(dispatchBtn, &QPushButton::clicked, this, &AddItemDialog::onDispatchClicked);

    QPushButton *queueBtn = new QPushButton("Queue", this);
    connect(queueBtn, &QPushButton::clicked, this, &AddItemDialog::onQueueClicked);

    QPushButton *scheduleBtn = new QPushButton("Schedule", this);
    connect(scheduleBtn, &QPushButton::clicked, this, &AddItemDialog::onScheduleClicked);
